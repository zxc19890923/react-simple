...
ngFileUpload.version = "12.0.1", ngFileUpload.service("UploadBase", ["$http", "$q", "$timeout", function (a, b, c) {
    ...
    function f(a, b, c) {
        ...
        return angular.forEach(a, function (d, f) {
            0 === d.type.indexOf("image/jpeg") && h.attrGetter("ngfFixOrientation", b, c, {$file: d}) && e.push(h.happyPromise(h.applyExifRotation(d), d).then(function (b) {
                a.splice(f, 1, b)
            }))
        }), d.all(e)
    }
        ...
        function e(d, e) {
            if (0 === d.type.indexOf("image")) {
                ...
                var i = h.resize(d, f.width, f.height, f.quality, f.type, f.ratio, f.centerCrop, function (a, e) {
                    return h.attrGetter("ngfResizeIf", b, c, {$width: a, $height: e, $file: d})
                }, f.restoreExif !== !1);
    ...
    return h.getAttrWithDefaults = function (a, b) {
        ...
        if (!x || r.length) {
            ...
            var z = h.attrGetter("ngfValidateAfterResize", d, e), A = r.length + s.length + t.length, B = h.attrGetter("ngModelOptions", d, e);
        ...
        function i(c, h, i, k, l) {
            function m(a, b, d) {
                null != d ? k(b, d).then(function (e) {
                    ...
                    j("ngfValidateForce", {$file: b}) ? (b.$error = c, (b.$errorMessages = b.$errorMessages || {}).name = !0, b.$errorParam = d, a.reject()) : a.resolve()
                }) : a.resolve()
            }
    ...
    return e.isExifSupported = function () {
        ...
        var c = b.defer(), d = new FileReader, e = a.slice(0, 65536);
